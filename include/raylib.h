...
typedef struct Rectangle2D {
    float x;                // Rectangle2D top-left corner position x 
    float y;                // Rectangle2D top-left corner position y
    float width;            // Rectangle2D width
    float height;           // Rectangle2D height
} Rectangle2D;
...
typedef struct NPatchInfo {
    Rectangle2D source;       // Texture source Rectangle2D
...
//------------------------------------------------------------------------------------
// Set texture and Rectangle2D to be used on shapes drawing
// NOTE: It can be useful when using basic shapes and one single font,
// defining a font char white Rectangle2D would allow drawing everything in a single draw call
RLAPI void SetShapesTexture(Texture2D texture, Rectangle2D source);       // Set texture and Rectangle2D to be used on shapes drawing
...
RLAPI void DrawRectangleV(Vector2 position, Vector2 size, Color color);                                  // Draw a color-filled Rectangle2D (Vector version)
RLAPI void DrawRectangleRec(Rectangle2D rec, Color color);                                                 // Draw a color-filled rectangle
RLAPI void DrawRectanglePro(Rectangle2D rec, Vector2 origin, float rotation, Color color);                 // Draw a color-filled Rectangle2D with pro parameters
RLAPI void DrawRectangleGradientV(int posX, int posY, int width, int height, Color color1, Color color2);// Draw a vertical-gradient-filled rectangle
RLAPI void DrawRectangleGradientH(int posX, int posY, int width, int height, Color color1, Color color2);// Draw a horizontal-gradient-filled rectangle
RLAPI void DrawRectangleGradientEx(Rectangle2D rec, Color col1, Color col2, Color col3, Color col4);       // Draw a gradient-filled Rectangle2D with custom vertex colors
RLAPI void DrawRectangleLines(int posX, int posY, int width, int height, Color color);                   // Draw Rectangle2D outline
RLAPI void DrawRectangleLinesEx(Rectangle2D rec, float lineThick, Color color);                            // Draw Rectangle2D outline with extended parameters
RLAPI void DrawRectangleRounded(Rectangle2D rec, float roundness, int segments, Color color);              // Draw Rectangle2D with rounded edges
RLAPI void DrawRectangleRoundedLines(Rectangle2D rec, float roundness, int segments, float lineThick, Color color); // Draw Rectangle2D with rounded edges outline
...
RLAPI bool CheckCollisionRecs(Rectangle2D rec1, Rectangle2D rec2);                                           // Check collision between two rectangles
RLAPI bool CheckCollisionCircles(Vector2 center1, float radius1, Vector2 center2, float radius2);        // Check collision between two circles
RLAPI bool CheckCollisionCircleRec(Vector2 center, float radius, Rectangle2D rec);                         // Check collision between circle and rectangle
RLAPI bool CheckCollisionPointRec(Vector2 point, Rectangle2D rec);                                         // Check if point is inside rectangle
RLAPI bool CheckCollisionPointCircle(Vector2 point, Vector2 center, float radius);                       // Check if point is inside circle
RLAPI bool CheckCollisionPointTriangle(Vector2 point, Vector2 p1, Vector2 p2, Vector2 p3);               // Check if point is inside a triangle
RLAPI bool CheckCollisionLines(Vector2 startPos1, Vector2 endPos1, Vector2 startPos2, Vector2 endPos2, Vector2 *collisionPoint); // Check the collision between two lines defined by two points each, returns collision point by reference
RLAPI Rectangle2D GetCollisionRec(Rectangle2D rec1, Rectangle2D rec2);                                         // Get collision Rectangle2D for two rectangles collision
...
RLAPI Image ImageFromImage(Image image, Rectangle2D rec);                                                  // Create an image from another image piece
RLAPI Image ImageText(const char *text, int fontSize, Color color);                                      // Create an image from text (default font)
RLAPI Image ImageTextEx(Font font, const char *text, float fontSize, float spacing, Color tint);         // Create an image from text (custom sprite font)
RLAPI void ImageFormat(Image *image, int newFormat);                                                     // Convert image data to desired format
RLAPI void ImageToPOT(Image *image, Color fill);                                                         // Convert image to POT (power-of-two)
RLAPI void ImageCrop(Image *image, Rectangle2D crop);                                                      // Crop an image to a defined rectangle
...
RLAPI Rectangle2D GetImageAlphaBorder(Image image, float threshold);                                       // Get image alpha border rectangle
...
RLAPI void ImageDrawRectangle(Image *dst, int posX, int posY, int width, int height, Color color);       // Draw Rectangle2D within an image
RLAPI void ImageDrawRectangleV(Image *dst, Vector2 position, Vector2 size, Color color);                 // Draw Rectangle2D within an image (Vector version)
RLAPI void ImageDrawRectangleRec(Image *dst, Rectangle2D rec, Color color);                                // Draw Rectangle2D within an image
RLAPI void ImageDrawRectangleLines(Image *dst, Rectangle2D rec, int thick, Color color);                   // Draw Rectangle2D lines within an image
RLAPI void ImageDraw(Image *dst, Image src, Rectangle2D srcRec, Rectangle2D dstRec, Color tint);             // Draw a source image within a destination image (tint applied to source)
...
RLAPI void UpdateTextureRec(Texture2D texture, Rectangle2D rec, const void *pixels);                       // Update GPU texture Rectangle2D with new data
...
RLAPI void DrawTextureRec(Texture2D texture, Rectangle2D source, Vector2 position, Color tint);            // Draw a part of a texture defined by a rectangle
RLAPI void DrawTextureQuad(Texture2D texture, Vector2 tiling, Vector2 offset, Rectangle2D quad, Color tint);  // Draw texture quad with tiling and offset parameters
RLAPI void DrawTextureTiled(Texture2D texture, Rectangle2D source, Rectangle2D dest, Vector2 origin, float rotation, float scale, Color tint);      // Draw part of a texture (defined by a rectangle) with rotation and scale tiled into dest.
RLAPI void DrawTexturePro(Texture2D texture, Rectangle2D source, Rectangle2D dest, Vector2 origin, float rotation, Color tint);           // Draw a part of a texture defined by a Rectangle2D with 'pro' parameters
RLAPI void DrawTextureNPatch(Texture2D texture, NPatchInfo nPatchInfo, Rectangle2D dest, Vector2 origin, float rotation, Color tint);   // Draws a texture (or part of it) that stretches or shrinks nicely
...
RLAPI Image GenImageFontAtlas(const CharInfo *chars, Rectangle2D **recs, int charsCount, int fontSize, int padding, int packMethod);      // Generate image font atlas using chars info
...
RLAPI void DrawTextRec(Font font, const char *text, Rectangle2D rec, float fontSize, float spacing, bool wordWrap, Color tint);   // Draw text using font inside Rectangle2D limits
RLAPI void DrawTextRecEx(Font font, const char *text, Rectangle2D rec, float fontSize, float spacing, bool wordWrap, Color tint, int selectStart, int selectLength, Color selectTint, Color selectBackTint);    // Draw text using font inside Rectangle2D limits with support for text selection
...
RLAPI void DrawBillboardRec(Camera camera, Texture2D texture, Rectangle2D source, Vector3 position, Vector2 size, Color tint); // Draw a billboard texture defined by source
RLAPI void DrawBillboardPro(Camera camera, Texture2D texture, Rectangle2D source, Vector3 position, Vector2 size, Vector2 origin, float rotation, Color tint); // Draw a billboard texture defined by source and rotation
